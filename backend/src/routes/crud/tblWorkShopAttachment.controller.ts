...
export const ServiceTblWorkShopAttachment = new BaseService(prisma.tblWorkShopAttachment);
...
const ControllerTblWorkShopAttachment = new BaseController({
  ...
  responseSchema: buildResponseSchema(TblWorkShopAttachmentPlain, TblWorkShopAttachment),
}).app;
