...
export async function effectCompTypeJobChange({ compTypeJobId, operation, }) {
    return prisma.$transaction(async (tx) => {
        ...
        const { compTypeId, jobDescId, discId, frequency, frequencyPeriod, jobConditionId, planningMethod, window, outputFormat, active, mandatoryResource, deptId, priority, maintClassId, maintCauseId, maintTypeId, statusNone, statusInUse, statusAvailable, statusRepair, } = compTypeJob;
