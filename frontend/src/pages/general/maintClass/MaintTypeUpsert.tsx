...
const defaultValues: MaintTypeFormValues = {
  description: "",
  orderNo: null,
};

function MaintTypeUpsert({
  entityName,
  open,
  mode,
  recordId,
  ...
  const {
    ...
    title,
    handleFormSubmit,
  } = useUpsertForm<MaintTypeFormValues, TypeTblMaintType>({
    entityName,
    open,
    mode,
    recordId,
    ...
    onFetch: async (id) => {
      const res = await tblMaintType.getById(id);
