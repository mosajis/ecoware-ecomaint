...
import { AccountTree, Apps, AttachFile, BarChart, BugReport, ContentCopy, Description, DoneAll, } from "@mui/icons-material";
...
const ComponentUnitTabs = [
    ...
    { label: "Rotation Log", icon: _jsx(EditNoteIcon, {}) },
];
const TabsComponent = () => {
