...
import { AccountTree, Apps, AttachFile, BarChart, BugReport, ContentCopy, } from "@mui/icons-material";
...
const ComponentUnitTabs = [
    ...
    { label: "Component", icon: _jsx(ContentCopy, {}), Component: TabWorkOrder },
    { label: "Attachment", icon: _jsx(AttachFile, {}), Component: TabAttachment },
    { label: "Spare", icon: _jsx(BugReport, {}), Component: TabFailureReport },
    { label: "Measure", icon: _jsx(EditNoteIcon, {}) },
