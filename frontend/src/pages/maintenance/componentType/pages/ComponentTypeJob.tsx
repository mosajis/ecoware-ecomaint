...
//   const { id } = useParams({ from: maintComponentTypeJobRoute.id })
//   const compTypeId = Number(id)

//   const match = useMatch({ from: maintComponentTypeJobRoute.id })
...
const ComponentTypeJob = () => {
  return <div>ComponentTypeJob</div>
}

export default ComponentTypeJob
