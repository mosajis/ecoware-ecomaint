...
const TabPerformed = () => {
    ...
    return (_jsx(Box, { display: "flex", flexDirection: "column", height: "100%", children: _jsx(CustomizedDataGrid, { style: { flex: 1 }, label: "Performed Maintenance", rows: rows, columns: columns }) }));
};
