...
const TabMaintLog = () => {
    ...
    return (_jsxs(Box, { display: "flex", flexDirection: "column", height: "100%", children: [_jsx(Stack, { direction: "row", spacing: 1, mb: 1, flexWrap: "wrap", children: [
                ...
                ].map((label) => (_jsx(Button, { variant: "outlined", size: "small", children: label }, label))) }), _jsx(CustomizedDataGrid, { style: { flex: 1 }, label: "Maintenance Log", rows: rows, columns: columns })] }));
};
