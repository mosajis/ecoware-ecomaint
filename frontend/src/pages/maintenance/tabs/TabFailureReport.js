...
const TabFailureReport = () => {
    ...
    return (_jsx(Box, { display: "flex", flexDirection: "column", height: "100%", children: _jsx(CustomizedDataGrid, { style: { flex: 1 }, label: "Failure Report", rows: rows, columns: columns }) }));
};
