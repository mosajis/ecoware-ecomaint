...
export default function ColorModeIconDropdown(props) {
    ...
    return (_jsxs(React.Fragment, { children: [_jsx(IconButton, { "data-screenshot": "toggle-mode", onClick: handleClick, disableRipple: true, size: "small", ...props, children: icon }), _jsxs(Menu, { anchorEl: anchorEl, id: "account-menu", open: open, onClose: handleClose, onClick: handleClose, slotProps: {
                    paper: {
                        variant: "outlined",
                        elevation: 0,
                        sx: {
