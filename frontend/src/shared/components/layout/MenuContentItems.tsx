...
export const menuContentItems: MenuSection[] = [
  ...
  // ================= QUICK ACCESS =================
  {
    ...
    items: [
      ...
      },
      {
        ...
        permit: getPremission(1610).canView,
      },
      {
        text: "Workshop",
  ...
  // ================= REPORT =================
  {
    ...
    path: "/report",
    permit: getPremission(1600).canView,
    items: [
      {
        text: "Failure Report",
        path: "/report/failure",
  ...
  // ================= USERS =================
  {
    ...
    path: "/access",
    permit: getPremission(1700).canView,
    items: [
      {
        text: "Users",
        icon: <PeopleRoundedIcon sx={iconStyle} />,
        path: "/access/user",
        permit: getPremission(1710).canView,
      },
      {
        text: "Users Group",
        icon: <GroupRoundedIcon sx={iconStyle} />,
        path: "/access/user-group",
        permit: getPremission(1720).canView,
      },
    ],
  },
];
