...
export const navigationCustomizations = {
    ...
    MuiMenu: {
        styleOverrides: {
            ...
            paper: ({ theme }) => ({
                ...
                boxShadow: "hsla(138, 97%, 45%, 0.07) 0px 4px 16px 0px, hsla(220, 25%, 10%, 0.07) 0px 8px 16px -5px",
                [`& .${buttonBaseClasses.root}`]: {
                    "&.Mui-selected": {
                        backgroundColor: alpha(theme.palette.action.selected, 0.3),
                    },
    ...
    MuiSelect: {
        defaultProps: {
            IconComponent: forwardRef((props, ref) => (_jsx(UnfoldMoreRoundedIcon, { fontSize: "small", ...props, ref: ref }))),
        },
        styleOverrides: {
            root: ({ theme }) => ({
                borderRadius: (theme.vars || theme).shape.borderRadius,
