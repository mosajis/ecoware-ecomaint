...
export const tblSpareType = {
  ...
  getById: (id: number, query?: DynamicQuery<"getTblSpareTypeByPartTypeId">) =>
    api.get<DynamicResponse<"getTblSpareTypeByPartTypeId">>(
      `/tblSpareType/${id}`,
      { params: stringifyQuery(query) }
    ),
  ...
  update: (id: number, data: DynamicUpdate<"putTblSpareTypeByPartTypeId">) =>
    api.put<DynamicResponse<"putTblSpareTypeByPartTypeId">>(
      `/tblSpareType/${id}`,
      { data }
    ),
  deleteById: (
    id: number,
    query?: DynamicQuery<"deleteTblSpareTypeByPartTypeId">
  ) =>
    api.delete<DynamicResponse<"deleteTblSpareTypeByPartTypeId">>(
      `/tblSpareType/${id}`,
      { params: stringifyQuery(query) }
    ),
...
export const tblSpareUnit = {
  ...
  getById: (id: number, query?: DynamicQuery<"getTblSpareUnitByPartId">) =>
    api.get<DynamicResponse<"getTblSpareUnitByPartId">>(`/tblSpareUnit/${id}`, {
      params: stringifyQuery(query),
    }),
  ...
  update: (id: number, data: DynamicUpdate<"putTblSpareUnitByPartId">) =>
    api.put<DynamicResponse<"putTblSpareUnitByPartId">>(`/tblSpareUnit/${id}`, {
      data,
    }),
  deleteById: (
    id: number,
    query?: DynamicQuery<"deleteTblSpareUnitByPartId">
  ) =>
    api.delete<DynamicResponse<"deleteTblSpareUnitByPartId">>(
      `/tblSpareUnit/${id}`,
      { params: stringifyQuery(query) }
    ),
...
export const users = {
  getAll: (query?: DynamicQuery<"getUsers">) =>
    api.get<DynamicResponse<"getUsers">>("/users", {
      params: stringifyQuery(query),
    }),
  getById: (id: number, query?: DynamicQuery<"getUsersByUserId">) =>
    api.get<DynamicResponse<"getUsersByUserId">>(`/users/${id}`, {
      params: stringifyQuery(query),
    }),
  ...
  deleteById: (id: number, query?: DynamicQuery<"deleteUsersByUserId">) =>
    api.delete<DynamicResponse<"deleteUsersByUserId">>(`/users/${id}`, {
      params: stringifyQuery(query),
    }),
  deleteAll: (query?: DynamicQuery<"deleteUsers">) =>
    api.delete<DynamicResponse<"deleteUsers">>("/users", {
      params: stringifyQuery(query),
    }),
};
