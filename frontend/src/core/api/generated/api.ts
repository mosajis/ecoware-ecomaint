...
export const tblAddress = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblAddressByAddressId">,
    query?: DynamicQuery<"getTblAddressByAddressId">,
  ) =>
...
export const tblAttachment = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblAttachmentByAttachmentId">,
    query?: DynamicQuery<"getTblAttachmentByAttachmentId">,
  ) =>
    api.put<DynamicResponse<"putTblAttachmentByAttachmentId">>(
      `/tblAttachment/${id}`,
      { data, params: stringifyQuery(query) },
    ),
  deleteById: (
    id: number,
...
export const tblCompJob = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblCompJobByCompJobId">,
    query?: DynamicQuery<"getTblCompJobByCompJobId">,
  ) =>
...
export type TypeTblCompJobCounterAlert =
  DynamicResponse<"getTblCompJobCounterAlert">["items"][0];
export const tblCompJobCounterAlert = {
  getAll: (query?: DynamicQuery<"getTblCompJobCounterAlert">) =>
    api.get<DynamicResponse<"getTblCompJobCounterAlert">>(
      "/tblCompJobCounterAlert",
      { params: stringifyQuery(query) },
    ),
  count: (query?: DynamicQuery<"getTblCompJobCounterAlert">) =>
    api.get<DynamicResponse<"getTblCompJobCounterAlert">>(
      "/tblCompJobCounterAlert/count",
      { params: stringifyQuery(query) },
    ),
};
...
export const tblCompJobMeasurePoint = {
  ...
  update: (
    ...
    >(`/tblCompJobMeasurePoint/${id}`, { data, params: stringifyQuery(query) }),
  deleteById: (
    id: number,
...
export const tblCompMeasurePointLog = {
  ...
  update: (
    ...
    >(`/tblCompMeasurePointLog/${id}`, { data, params: stringifyQuery(query) }),
  deleteById: (
    id: number,
...
export const tblCompSpare = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblCompSpareByCompSpareId">,
    query?: DynamicQuery<"getTblCompSpareByCompSpareId">,
  ) =>
...
export const tblCompStatus = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblCompStatusByCompStatusId">,
    query?: DynamicQuery<"getTblCompStatusByCompStatusId">,
  ) =>
...
export const tblCompType = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblCompTypeByCompTypeId">,
    query?: DynamicQuery<"getTblCompTypeByCompTypeId">,
  ) =>
...
export const tblCompTypeAttachmentByCompTypeAttachmentIdEffect = {
  create: (
    data: DynamicCreate<"postTblCompTypeAttachmentByCompTypeAttachmentIdEffect">,
  ) =>
    api.post<
      DynamicResponse<"postTblCompTypeAttachmentByCompTypeAttachmentIdEffect">
    >("/tblCompTypeAttachmentByCompTypeAttachmentIdEffect", { data }),
};
...
export const tblCompTypeCounterByCompTypeCounterIdEffect = {
  create: (
    data: DynamicCreate<"postTblCompTypeCounterByCompTypeCounterIdEffect">,
  ) =>
    api.post<
      DynamicResponse<"postTblCompTypeCounterByCompTypeCounterIdEffect">
    >("/tblCompTypeCounterByCompTypeCounterIdEffect", { data }),
};
...
export const tblCompTypeJobCounterByCompTypeJobCounterIdEffect = {
  create: (
    data: DynamicCreate<"postTblCompTypeJobCounterByCompTypeJobCounterIdEffect">,
  ) =>
    api.post<
      DynamicResponse<"postTblCompTypeJobCounterByCompTypeJobCounterIdEffect">
    >("/tblCompTypeJobCounterByCompTypeJobCounterIdEffect", { data }),
};
...
export const tblCompTypeJobMeasurePointByCompTypeJobMeasurePointIdEffect = {
  create: (
    data: DynamicCreate<"postTblCompTypeJobMeasurePointByCompTypeJobMeasurePointIdEffect">,
  ) =>
    api.post<
      DynamicResponse<"postTblCompTypeJobMeasurePointByCompTypeJobMeasurePointIdEffect">
    >("/tblCompTypeJobMeasurePointByCompTypeJobMeasurePointIdEffect", { data }),
};
...
export const tblCompTypeJobTriggerByCompTypeJobTriggerIdEffect = {
  create: (
    data: DynamicCreate<"postTblCompTypeJobTriggerByCompTypeJobTriggerIdEffect">,
  ) =>
    api.post<
      DynamicResponse<"postTblCompTypeJobTriggerByCompTypeJobTriggerIdEffect">
    >("/tblCompTypeJobTriggerByCompTypeJobTriggerIdEffect", { data }),
};
...
export const tblCompTypeMeasurePointByCompTypeMeasurePointIdEffect = {
  create: (
    data: DynamicCreate<"postTblCompTypeMeasurePointByCompTypeMeasurePointIdEffect">,
  ) =>
    api.post<
      DynamicResponse<"postTblCompTypeMeasurePointByCompTypeMeasurePointIdEffect">
    >("/tblCompTypeMeasurePointByCompTypeMeasurePointIdEffect", { data }),
};
...
export const tblComponentUnit = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblComponentUnitByCompId">,
    query?: DynamicQuery<"getTblComponentUnitByCompId">,
  ) =>
...
export const tblDepartment = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblDepartmentByDeptId">,
    query?: DynamicQuery<"getTblDepartmentByDeptId">,
  ) =>
...
export const tblDiscipline = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblDisciplineByDiscId">,
    query?: DynamicQuery<"getTblDisciplineByDiscId">,
  ) =>
...
export const tblElement = {
  getAll: (query?: DynamicQuery<"getTblElement">) =>
    api.get<DynamicResponse<"getTblElement">>("/tblElement", {
      params: stringifyQuery(query),
    }),
  getById: (id: number, query?: DynamicQuery<"getTblElementByElementId">) =>
    api.get<DynamicResponse<"getTblElementByElementId">>(`/tblElement/${id}`, {
      params: stringifyQuery(query),
    }),
  count: (query?: DynamicQuery<"getTblElementCount">) =>
    api.get<DynamicResponse<"getTblElementCount">>("/tblElement/count", {
      params: stringifyQuery(query),
    }),
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblElementByElementId">,
    query?: DynamicQuery<"getTblElementByElementId">,
  ) =>
    api.put<DynamicResponse<"putTblElementByElementId">>(`/tblElement/${id}`, {
      data,
      params: stringifyQuery(query),
    }),
  deleteById: (
    id: number,
    query?: DynamicQuery<"deleteTblElementByElementId">,
  ) =>
    api.delete<DynamicResponse<"deleteTblElementByElementId">>(
      `/tblElement/${id}`,
      { params: stringifyQuery(query) },
    ),
  deleteAll: (query?: DynamicQuery<"deleteTblElement">) =>
    api.delete<DynamicResponse<"deleteTblElement">>("/tblElement", {
      params: stringifyQuery(query),
    }),
};
...
export const tblEmployee = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblEmployeeByEmployeeId">,
    query?: DynamicQuery<"getTblEmployeeByEmployeeId">,
  ) =>
...
export type TypeTblFailureReport =
  DynamicResponse<"getTblFailureReport">["items"][0];
export const tblFailureReport = {
  getAll: (query?: DynamicQuery<"getTblFailureReport">) =>
    api.get<DynamicResponse<"getTblFailureReport">>("/tblFailureReport", {
      params: stringifyQuery(query),
    }),
  getById: (
    id: number,
    query?: DynamicQuery<"getTblFailureReportByFailureReportId">,
  ) =>
    api.get<DynamicResponse<"getTblFailureReportByFailureReportId">>(
      `/tblFailureReport/${id}`,
      { params: stringifyQuery(query) },
    ),
  count: (query?: DynamicQuery<"getTblFailureReportCount">) =>
    api.get<DynamicResponse<"getTblFailureReportCount">>(
      "/tblFailureReport/count",
      { params: stringifyQuery(query) },
    ),
  create: (data: DynamicCreate<"postTblFailureReport">) =>
    api.post<DynamicResponse<"postTblFailureReport">>("/tblFailureReport", {
      data,
    }),
  update: (
    id: number,
    data: DynamicUpdate<"putTblFailureReportByFailureReportId">,
    query?: DynamicQuery<"getTblFailureReportByFailureReportId">,
  ) =>
    api.put<DynamicResponse<"putTblFailureReportByFailureReportId">>(
      `/tblFailureReport/${id}`,
      { data, params: stringifyQuery(query) },
    ),
  deleteById: (
    id: number,
    query?: DynamicQuery<"deleteTblFailureReportByFailureReportId">,
  ) =>
    api.delete<DynamicResponse<"deleteTblFailureReportByFailureReportId">>(
      `/tblFailureReport/${id}`,
      { params: stringifyQuery(query) },
    ),
  deleteAll: (query?: DynamicQuery<"deleteTblFailureReport">) =>
    api.delete<DynamicResponse<"deleteTblFailureReport">>("/tblFailureReport", {
      params: stringifyQuery(query),
    }),
};

export type TypeTblFailureReportWorkShop =
  DynamicResponse<"getTblFailureReportWorkShop">["items"][0];
export const tblFailureReportWorkShop = {
  getAll: (query?: DynamicQuery<"getTblFailureReportWorkShop">) =>
    api.get<DynamicResponse<"getTblFailureReportWorkShop">>(
      "/tblFailureReportWorkShop",
      { params: stringifyQuery(query) },
    ),
  getById: (
    id: number,
    query?: DynamicQuery<"getTblFailureReportWorkShopByFailureReportWorkShopId">,
  ) =>
    api.get<
      DynamicResponse<"getTblFailureReportWorkShopByFailureReportWorkShopId">
    >(`/tblFailureReportWorkShop/${id}`, { params: stringifyQuery(query) }),
  count: (query?: DynamicQuery<"getTblFailureReportWorkShopCount">) =>
    api.get<DynamicResponse<"getTblFailureReportWorkShopCount">>(
      "/tblFailureReportWorkShop/count",
      { params: stringifyQuery(query) },
    ),
  create: (data: DynamicCreate<"postTblFailureReportWorkShop">) =>
    api.post<DynamicResponse<"postTblFailureReportWorkShop">>(
      "/tblFailureReportWorkShop",
      { data },
    ),
  update: (
    id: number,
    data: DynamicUpdate<"putTblFailureReportWorkShopByFailureReportWorkShopId">,
    query?: DynamicQuery<"getTblFailureReportWorkShopByFailureReportWorkShopId">,
  ) =>
    api.put<
      DynamicResponse<"putTblFailureReportWorkShopByFailureReportWorkShopId">
    >(`/tblFailureReportWorkShop/${id}`, {
      data,
      params: stringifyQuery(query),
    }),
  deleteById: (
    id: number,
    query?: DynamicQuery<"deleteTblFailureReportWorkShopByFailureReportWorkShopId">,
  ) =>
    api.delete<
      DynamicResponse<"deleteTblFailureReportWorkShopByFailureReportWorkShopId">
    >(`/tblFailureReportWorkShop/${id}`, { params: stringifyQuery(query) }),
  deleteAll: (query?: DynamicQuery<"deleteTblFailureReportWorkShop">) =>
    api.delete<DynamicResponse<"deleteTblFailureReportWorkShop">>(
      "/tblFailureReportWorkShop",
      { params: stringifyQuery(query) },
    ),
};
...
export const tblFunction = {
  getAll: (query?: DynamicQuery<"getTblFunction">) =>
    api.get<DynamicResponse<"getTblFunction">>("/tblFunction", {
      params: stringifyQuery(query),
    }),
  getById: (id: number, query?: DynamicQuery<"getTblFunctionByFunctionId">) =>
    api.get<DynamicResponse<"getTblFunctionByFunctionId">>(
      `/tblFunction/${id}`,
      { params: stringifyQuery(query) },
    ),
  count: (query?: DynamicQuery<"getTblFunctionCount">) =>
    api.get<DynamicResponse<"getTblFunctionCount">>("/tblFunction/count", {
      params: stringifyQuery(query),
    }),
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblFunctionByFunctionId">,
    query?: DynamicQuery<"getTblFunctionByFunctionId">,
  ) =>
    api.put<DynamicResponse<"putTblFunctionByFunctionId">>(
      `/tblFunction/${id}`,
      { data, params: stringifyQuery(query) },
    ),
  deleteById: (
    id: number,
    query?: DynamicQuery<"deleteTblFunctionByFunctionId">,
  ) =>
    api.delete<DynamicResponse<"deleteTblFunctionByFunctionId">>(
      `/tblFunction/${id}`,
      { params: stringifyQuery(query) },
    ),
  deleteAll: (query?: DynamicQuery<"deleteTblFunction">) =>
    api.delete<DynamicResponse<"deleteTblFunction">>("/tblFunction", {
      params: stringifyQuery(query),
    }),
};

export type TypeTblInstallation =
  DynamicResponse<"getTblInstallation">["items"][0];
export const tblInstallation = {
  getAll: (query?: DynamicQuery<"getTblInstallation">) =>
    api.get<DynamicResponse<"getTblInstallation">>("/tblInstallation", {
      params: stringifyQuery(query),
    }),
  getById: (id: number, query?: DynamicQuery<"getTblInstallationByInstId">) =>
    api.get<DynamicResponse<"getTblInstallationByInstId">>(
      `/tblInstallation/${id}`,
      { params: stringifyQuery(query) },
    ),
  count: (query?: DynamicQuery<"getTblInstallationCount">) =>
    api.get<DynamicResponse<"getTblInstallationCount">>(
      "/tblInstallation/count",
      { params: stringifyQuery(query) },
    ),
  create: (data: DynamicCreate<"postTblInstallation">) =>
    api.post<DynamicResponse<"postTblInstallation">>("/tblInstallation", {
      data,
    }),
  update: (
    id: number,
    data: DynamicUpdate<"putTblInstallationByInstId">,
    query?: DynamicQuery<"getTblInstallationByInstId">,
  ) =>
    api.put<DynamicResponse<"putTblInstallationByInstId">>(
      `/tblInstallation/${id}`,
      { data, params: stringifyQuery(query) },
    ),
  deleteById: (
    id: number,
    query?: DynamicQuery<"deleteTblInstallationByInstId">,
  ) =>
    api.delete<DynamicResponse<"deleteTblInstallationByInstId">>(
      `/tblInstallation/${id}`,
      { params: stringifyQuery(query) },
    ),
  deleteAll: (query?: DynamicQuery<"deleteTblInstallation">) =>
    api.delete<DynamicResponse<"deleteTblInstallation">>("/tblInstallation", {
      params: stringifyQuery(query),
    }),
};
...
export const tblJobClass = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblJobClassByJobClassId">,
    query?: DynamicQuery<"getTblJobClassByJobClassId">,
  ) =>
...
export const tblJobDescriptionAttachment = {
  ...
  update: (
    ...
    >(`/tblJobDescriptionAttachment/${id}`, {
      data,
      params: stringifyQuery(query),
    }),
  deleteById: (
...
export const tblJobTrigger = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblJobTriggerByJobTriggerId">,
    query?: DynamicQuery<"getTblJobTriggerByJobTriggerId">,
  ) =>
...
export const tblJobTriggerByJobTriggerIdGenerate = {
  create: (data: DynamicCreate<"postTblJobTriggerByJobTriggerIdGenerate">) =>
    api.post<DynamicResponse<"postTblJobTriggerByJobTriggerIdGenerate">>(
      "/tblJobTriggerByJobTriggerIdGenerate",
      { data },
    ),
};
...
export const tblJobVersion = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblJobVersionByJobVersionId">,
    query?: DynamicQuery<"getTblJobVersionByJobVersionId">,
  ) =>
...
export const tblLocation = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblLocationByLocationId">,
    query?: DynamicQuery<"getTblLocationByLocationId">,
  ) =>
...
export const tblLogCounter = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblLogCounterByLogCounterId">,
    query?: DynamicQuery<"getTblLogCounterByLogCounterId">,
  ) =>
...
export const tblLogDiscipline = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblLogDisciplineByLogDiscId">,
    query?: DynamicQuery<"getTblLogDisciplineByLogDiscId">,
  ) =>
...
export const tblLoginAudit = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblLoginAuditByLoginAuditId">,
    query?: DynamicQuery<"getTblLoginAuditByLoginAuditId">,
  ) =>
...
export const tblMaintCause = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblMaintCauseByMaintCauseId">,
    query?: DynamicQuery<"getTblMaintCauseByMaintCauseId">,
  ) =>
...
export const tblMaintClass = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblMaintClassByMaintClassId">,
    query?: DynamicQuery<"getTblMaintClassByMaintClassId">,
  ) =>
...
export const tblMaintLog = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblMaintLogByMaintLogId">,
    query?: DynamicQuery<"getTblMaintLogByMaintLogId">,
  ) =>
...
export const tblMaintLogFollow = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblMaintLogFollowByFollowId">,
    query?: DynamicQuery<"getTblMaintLogFollowByFollowId">,
  ) =>
...
export type TypeTblMaintLogSpare =
  DynamicResponse<"getTblMaintLogSpare">["items"][0];
export const tblMaintLogSpare = {
  getAll: (query?: DynamicQuery<"getTblMaintLogSpare">) =>
    api.get<DynamicResponse<"getTblMaintLogSpare">>("/tblMaintLogSpare", {
      params: stringifyQuery(query),
    }),
  getById: (
    id: number,
    query?: DynamicQuery<"getTblMaintLogSpareByMaintLogSpareId">,
  ) =>
    api.get<DynamicResponse<"getTblMaintLogSpareByMaintLogSpareId">>(
      `/tblMaintLogSpare/${id}`,
      { params: stringifyQuery(query) },
    ),
  count: (query?: DynamicQuery<"getTblMaintLogSpareCount">) =>
    api.get<DynamicResponse<"getTblMaintLogSpareCount">>(
      "/tblMaintLogSpare/count",
      { params: stringifyQuery(query) },
    ),
  create: (data: DynamicCreate<"postTblMaintLogSpare">) =>
    api.post<DynamicResponse<"postTblMaintLogSpare">>("/tblMaintLogSpare", {
      data,
    }),
  update: (
    id: number,
    data: DynamicUpdate<"putTblMaintLogSpareByMaintLogSpareId">,
    query?: DynamicQuery<"getTblMaintLogSpareByMaintLogSpareId">,
  ) =>
    api.put<DynamicResponse<"putTblMaintLogSpareByMaintLogSpareId">>(
      `/tblMaintLogSpare/${id}`,
      { data, params: stringifyQuery(query) },
    ),
  deleteById: (
    id: number,
    query?: DynamicQuery<"deleteTblMaintLogSpareByMaintLogSpareId">,
  ) =>
    api.delete<DynamicResponse<"deleteTblMaintLogSpareByMaintLogSpareId">>(
      `/tblMaintLogSpare/${id}`,
      { params: stringifyQuery(query) },
    ),
  deleteAll: (query?: DynamicQuery<"deleteTblMaintLogSpare">) =>
    api.delete<DynamicResponse<"deleteTblMaintLogSpare">>("/tblMaintLogSpare", {
      params: stringifyQuery(query),
    }),
};
...
export const tblMaintType = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblMaintTypeByMaintTypeId">,
    query?: DynamicQuery<"getTblMaintTypeByMaintTypeId">,
  ) =>
...
export const tblPendingType = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblPendingTypeByPendTypeId">,
    query?: DynamicQuery<"getTblPendingTypeByPendTypeId">,
  ) =>
...
export const tblPeriod = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblPeriodByPeriodId">,
    query?: DynamicQuery<"getTblPeriodByPeriodId">,
  ) =>
...
export const tblRound = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblRoundByRoundId">,
    query?: DynamicQuery<"getTblRoundByRoundId">,
  ) =>
...
export const tblSpareType = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblSpareTypeBySpareTypeId">,
    query?: DynamicQuery<"getTblSpareTypeBySpareTypeId">,
  ) =>
...
export const tblSpareUnit = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblSpareUnitBySpareUnitId">,
    query?: DynamicQuery<"getTblSpareUnitBySpareUnitId">,
  ) =>
...
export const tblUnit = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblUnitByUnitId">,
    query?: DynamicQuery<"getTblUnitByUnitId">,
  ) =>
    api.put<DynamicResponse<"putTblUnitByUnitId">>(`/tblUnit/${id}`, {
      data,
      params: stringifyQuery(query),
    }),
...
export const tblUser = {
  getAll: (query?: DynamicQuery<"getTblUser">) =>
    api.get<DynamicResponse<"getTblUser">>("/tblUser", {
      params: stringifyQuery(query),
    }),
  getById: (id: number, query?: DynamicQuery<"getTblUserByUserId">) =>
    api.get<DynamicResponse<"getTblUserByUserId">>(`/tblUser/${id}`, {
      params: stringifyQuery(query),
    }),
  count: (query?: DynamicQuery<"getTblUserCount">) =>
    api.get<DynamicResponse<"getTblUserCount">>("/tblUser/count", {
      params: stringifyQuery(query),
    }),
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblUserByUserId">,
    query?: DynamicQuery<"getTblUserByUserId">,
  ) =>
    api.put<DynamicResponse<"putTblUserByUserId">>(`/tblUser/${id}`, {
      data,
      params: stringifyQuery(query),
    }),
  deleteById: (id: number, query?: DynamicQuery<"deleteTblUserByUserId">) =>
    api.delete<DynamicResponse<"deleteTblUserByUserId">>(`/tblUser/${id}`, {
      params: stringifyQuery(query),
    }),
  deleteAll: (query?: DynamicQuery<"deleteTblUser">) =>
    api.delete<DynamicResponse<"deleteTblUser">>("/tblUser", {
      params: stringifyQuery(query),
    }),
};
...
export const tblUserGroup = {
  getAll: (query?: DynamicQuery<"getTblUserGroup">) =>
    api.get<DynamicResponse<"getTblUserGroup">>("/tblUserGroup", {
      params: stringifyQuery(query),
    }),
  getById: (id: number, query?: DynamicQuery<"getTblUserGroupByUserGroupId">) =>
    api.get<DynamicResponse<"getTblUserGroupByUserGroupId">>(
      `/tblUserGroup/${id}`,
      { params: stringifyQuery(query) },
    ),
  count: (query?: DynamicQuery<"getTblUserGroupCount">) =>
    api.get<DynamicResponse<"getTblUserGroupCount">>("/tblUserGroup/count", {
      params: stringifyQuery(query),
    }),
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblUserGroupByUserGroupId">,
    query?: DynamicQuery<"getTblUserGroupByUserGroupId">,
  ) =>
    api.put<DynamicResponse<"putTblUserGroupByUserGroupId">>(
      `/tblUserGroup/${id}`,
      { data, params: stringifyQuery(query) },
    ),
  deleteById: (
    id: number,
    query?: DynamicQuery<"deleteTblUserGroupByUserGroupId">,
  ) =>
    api.delete<DynamicResponse<"deleteTblUserGroupByUserGroupId">>(
      `/tblUserGroup/${id}`,
      { params: stringifyQuery(query) },
    ),
  deleteAll: (query?: DynamicQuery<"deleteTblUserGroup">) =>
    api.delete<DynamicResponse<"deleteTblUserGroup">>("/tblUserGroup", {
      params: stringifyQuery(query),
    }),
};

export type TypeTblUserGroupElement =
  DynamicResponse<"getTblUserGroupElement">["items"][0];
export const tblUserGroupElement = {
  getAll: (query?: DynamicQuery<"getTblUserGroupElement">) =>
    api.get<DynamicResponse<"getTblUserGroupElement">>("/tblUserGroupElement", {
      params: stringifyQuery(query),
    }),
  getById: (
    id: number,
    query?: DynamicQuery<"getTblUserGroupElementByUserGroupElementId">,
  ) =>
    api.get<DynamicResponse<"getTblUserGroupElementByUserGroupElementId">>(
      `/tblUserGroupElement/${id}`,
      { params: stringifyQuery(query) },
    ),
  count: (query?: DynamicQuery<"getTblUserGroupElementCount">) =>
    api.get<DynamicResponse<"getTblUserGroupElementCount">>(
      "/tblUserGroupElement/count",
      { params: stringifyQuery(query) },
    ),
  create: (data: DynamicCreate<"postTblUserGroupElement">) =>
    api.post<DynamicResponse<"postTblUserGroupElement">>(
      "/tblUserGroupElement",
      { data },
    ),
  update: (
    id: number,
    data: DynamicUpdate<"putTblUserGroupElementByUserGroupElementId">,
    query?: DynamicQuery<"getTblUserGroupElementByUserGroupElementId">,
  ) =>
    api.put<DynamicResponse<"putTblUserGroupElementByUserGroupElementId">>(
      `/tblUserGroupElement/${id}`,
      { data, params: stringifyQuery(query) },
    ),
  deleteById: (
    id: number,
    query?: DynamicQuery<"deleteTblUserGroupElementByUserGroupElementId">,
  ) =>
    api.delete<
      DynamicResponse<"deleteTblUserGroupElementByUserGroupElementId">
    >(`/tblUserGroupElement/${id}`, { params: stringifyQuery(query) }),
  deleteAll: (query?: DynamicQuery<"deleteTblUserGroupElement">) =>
    api.delete<DynamicResponse<"deleteTblUserGroupElement">>(
      "/tblUserGroupElement",
      { params: stringifyQuery(query) },
    ),
};

export type TypeTblUserInstallation =
  DynamicResponse<"getTblUserInstallation">["items"][0];
export const tblUserInstallation = {
  getAll: (query?: DynamicQuery<"getTblUserInstallation">) =>
    api.get<DynamicResponse<"getTblUserInstallation">>("/tblUserInstallation", {
      params: stringifyQuery(query),
    }),
  getById: (
    id: number,
    query?: DynamicQuery<"getTblUserInstallationByUserInstId">,
  ) =>
    api.get<DynamicResponse<"getTblUserInstallationByUserInstId">>(
      `/tblUserInstallation/${id}`,
      { params: stringifyQuery(query) },
    ),
  count: (query?: DynamicQuery<"getTblUserInstallationCount">) =>
    api.get<DynamicResponse<"getTblUserInstallationCount">>(
      "/tblUserInstallation/count",
      { params: stringifyQuery(query) },
    ),
  create: (data: DynamicCreate<"postTblUserInstallation">) =>
    api.post<DynamicResponse<"postTblUserInstallation">>(
      "/tblUserInstallation",
      { data },
    ),
  update: (
    id: number,
    data: DynamicUpdate<"putTblUserInstallationByUserInstId">,
    query?: DynamicQuery<"getTblUserInstallationByUserInstId">,
  ) =>
    api.put<DynamicResponse<"putTblUserInstallationByUserInstId">>(
      `/tblUserInstallation/${id}`,
      { data, params: stringifyQuery(query) },
    ),
  deleteById: (
    id: number,
    query?: DynamicQuery<"deleteTblUserInstallationByUserInstId">,
  ) =>
    api.delete<DynamicResponse<"deleteTblUserInstallationByUserInstId">>(
      `/tblUserInstallation/${id}`,
      { params: stringifyQuery(query) },
    ),
  deleteAll: (query?: DynamicQuery<"deleteTblUserInstallation">) =>
    api.delete<DynamicResponse<"deleteTblUserInstallation">>(
      "/tblUserInstallation",
      { params: stringifyQuery(query) },
    ),
};
...
export const tblWorkOrder = {
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblWorkOrderByWorkOrderId">,
    query?: DynamicQuery<"getTblWorkOrderByWorkOrderId">,
  ) =>
...
export const tblWorkShop = {
  getAll: (query?: DynamicQuery<"getTblWorkShop">) =>
    api.get<DynamicResponse<"getTblWorkShop">>("/tblWorkShop", {
      params: stringifyQuery(query),
    }),
  getById: (id: number, query?: DynamicQuery<"getTblWorkShopByWorkShopId">) =>
    api.get<DynamicResponse<"getTblWorkShopByWorkShopId">>(
      `/tblWorkShop/${id}`,
      { params: stringifyQuery(query) },
    ),
  count: (query?: DynamicQuery<"getTblWorkShopCount">) =>
    api.get<DynamicResponse<"getTblWorkShopCount">>("/tblWorkShop/count", {
      params: stringifyQuery(query),
    }),
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblWorkShopByWorkShopId">,
    query?: DynamicQuery<"getTblWorkShopByWorkShopId">,
  ) =>
    api.put<DynamicResponse<"putTblWorkShopByWorkShopId">>(
      `/tblWorkShop/${id}`,
      { data, params: stringifyQuery(query) },
    ),
  deleteById: (
    id: number,
    query?: DynamicQuery<"deleteTblWorkShopByWorkShopId">,
  ) =>
    api.delete<DynamicResponse<"deleteTblWorkShopByWorkShopId">>(
      `/tblWorkShop/${id}`,
      { params: stringifyQuery(query) },
    ),
  deleteAll: (query?: DynamicQuery<"deleteTblWorkShop">) =>
    api.delete<DynamicResponse<"deleteTblWorkShop">>("/tblWorkShop", {
      params: stringifyQuery(query),
    }),
};

export type TypeTblWorkShopAttachment =
  DynamicResponse<"getTblWorkShopAttachment">["items"][0];
export const tblWorkShopAttachment = {
  getAll: (query?: DynamicQuery<"getTblWorkShopAttachment">) =>
    api.get<DynamicResponse<"getTblWorkShopAttachment">>(
      "/tblWorkShopAttachment",
      { params: stringifyQuery(query) },
    ),
  getById: (
    id: number,
    query?: DynamicQuery<"getTblWorkShopAttachmentByWorkShopAttachmentId">,
  ) =>
    api.get<DynamicResponse<"getTblWorkShopAttachmentByWorkShopAttachmentId">>(
      `/tblWorkShopAttachment/${id}`,
      { params: stringifyQuery(query) },
    ),
  count: (query?: DynamicQuery<"getTblWorkShopAttachmentCount">) =>
    api.get<DynamicResponse<"getTblWorkShopAttachmentCount">>(
      "/tblWorkShopAttachment/count",
      { params: stringifyQuery(query) },
    ),
  create: (data: DynamicCreate<"postTblWorkShopAttachment">) =>
    api.post<DynamicResponse<"postTblWorkShopAttachment">>(
      "/tblWorkShopAttachment",
      { data },
    ),
  update: (
    id: number,
    data: DynamicUpdate<"putTblWorkShopAttachmentByWorkShopAttachmentId">,
    query?: DynamicQuery<"getTblWorkShopAttachmentByWorkShopAttachmentId">,
  ) =>
    api.put<DynamicResponse<"putTblWorkShopAttachmentByWorkShopAttachmentId">>(
      `/tblWorkShopAttachment/${id}`,
      { data, params: stringifyQuery(query) },
    ),
  deleteById: (
    id: number,
    query?: DynamicQuery<"deleteTblWorkShopAttachmentByWorkShopAttachmentId">,
  ) =>
    api.delete<
      DynamicResponse<"deleteTblWorkShopAttachmentByWorkShopAttachmentId">
    >(`/tblWorkShopAttachment/${id}`, { params: stringifyQuery(query) }),
  deleteAll: (query?: DynamicQuery<"deleteTblWorkShopAttachment">) =>
    api.delete<DynamicResponse<"deleteTblWorkShopAttachment">>(
      "/tblWorkShopAttachment",
      { params: stringifyQuery(query) },
    ),
};
...
export const tblWorkShopComponent = {
  ...
  getById: (
    id: number,
    query?: DynamicQuery<"getTblWorkShopComponentByWorkShopCompId">,
  ) =>
    api.get<DynamicResponse<"getTblWorkShopComponentByWorkShopCompId">>(
  ...
  update: (
    id: number,
    data: DynamicUpdate<"putTblWorkShopComponentByWorkShopCompId">,
    query?: DynamicQuery<"getTblWorkShopComponentByWorkShopCompId">,
  ) =>
    api.put<DynamicResponse<"putTblWorkShopComponentByWorkShopCompId">>(
      `/tblWorkShopComponent/${id}`,
      { data, params: stringifyQuery(query) },
    ),
  deleteById: (
    id: number,
    query?: DynamicQuery<"deleteTblWorkShopComponentByWorkShopCompId">,
  ) =>
    api.delete<DynamicResponse<"deleteTblWorkShopComponentByWorkShopCompId">>(
      `/tblWorkShopComponent/${id}`,
      { params: stringifyQuery(query) },
    ),
